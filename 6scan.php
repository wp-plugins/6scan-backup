...
if ( defined( 'SIXSCAN_PLATFORM_TYPE' ) ){
	...
	if ( SIXSCAN_PLATFORM_TYPE == 'wordpress' ){			
		die( 'You already have the 6Scan Security plugin installed.  The 6Scan Security plugin also provides full backup functionality -- simply access your dashboard and click the Backup tab.' );
	}
...
/* Platform type */
define ( 'SIXSCAN_PLATFORM_TYPE' , 	'wordpress_backup' );
